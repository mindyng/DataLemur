...
--goal compare followers to influencer's employers' followers
--get influencer's followers and compare with all their companies' followers
--join influencers profile to employee co and to company pages based on foreign keys
--then compare number of influencers and total influencers from all companies
SELECT profile_id
...
GROUP BY profile_id
, pp.followers
HAVING SUM(cp.followers) < pp.followers
ORDER BY 1
